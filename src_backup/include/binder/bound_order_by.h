...
class BoundOrderBy {
public:
  BoundOrderBy(OrderByType type, OrderByNullType null_order,
  ...
  auto ToString() const -> std::string {
    return fmt::format("BoundOrderBy {{ type={}, nulls={}, expr={} }}", type_,
                       null_order_, expr_);
  }
};
...
template <>
struct fmt::formatter<bustub::OrderByNullType>
