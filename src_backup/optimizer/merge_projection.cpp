 ...
 * Identical projection might be produced when there's `SELECT *`, aggregation,
 * or when we need to rename the columns in the planner. We merge these
 * projections so as to make execution faster.
 */
