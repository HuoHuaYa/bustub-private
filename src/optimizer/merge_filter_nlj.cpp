 ...
 * In planner, we plan cross join + filter with cross product (done with nested
 * loop join) and a filter plan node. We can merge the filter condition into
 * nested loop join to achieve better efficiency.
 */
