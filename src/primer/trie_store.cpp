...
/**
 * @brief This function returns a ValueGuard object that holds a reference to
 * the value in the trie. If the key does not exist in the trie, it will return
 * std::nullopt.
 */
template <class T>
...
/**
 * @brief This function will insert the key-value pair into the trie. If the key
