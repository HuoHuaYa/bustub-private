...
/**
 * @brief Put a new key-value pair into the trie. If the key already exists,
 * overwrite the value.
 * @return the new trie.
 */
 ...
 * @return If the key does not exist, return the original trie. Otherwise,
...
auto Trie::Remove(std::string_view key) const -> Trie {
  ...
  // doesn't contain a value anymore, you should convert it to `TrieNode`. If a
  // node doesn't have children anymore, you should remove it.
}
