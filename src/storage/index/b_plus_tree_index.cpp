...
INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_INDEX_TYPE::GetBeginIterator() -> SHORT_INDEXITERATOR_TYPE {
  return container_->Begin();
}

INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_INDEX_TYPE::GetBeginIterator(const KeyType &key)
    -> SHORT_INDEXITERATOR_TYPE {
  return container_->Begin(key);
}

INDEX_TEMPLATE_ARGUMENTS
auto BPLUSTREE_INDEX_TYPE::GetEndIterator() -> SHORT_INDEXITERATOR_TYPE {
